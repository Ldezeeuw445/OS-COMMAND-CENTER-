...
import {
  LayoutDashboard, Package, Bot, Server, DollarSign,
  Headphones, TrendingUp, Users, GitBranch, Settings,
  ChevronRight, Zap
} from 'lucide-react';
      ...
      <div className="px-3 py-3 border-b border-white/[0.04]">
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <div className="text-[8px] text-white/30 tracking-wider">CENTER</div>
          </div>
        </div>
      </div>
